package com.github.ariadineamaral.ms_pagamento.repository;
...
public class PagamentoRepositoryTest {
    ...
    @Test
    @DisplayName("Dado paraêmetros válidos e Id nulo Quando chamar Criar Pagamento Então deve instanciar um Pagamento")
